      ...
      <div className="max-w-md w-full space-y-8 relative z-10">
        <div className="text-center">
          ...
          <p className="mt-4 text-slate-500 font-bold">
            مرحباً بك مجدداً في نكسس للحلول البرمجية
          </p>
        </div>
        ...
        <div className="bg-white/70 backdrop-blur-xl p-10 rounded-[40px] shadow-2xl border border-white shadow-slate-200">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between px-1">
              <div className="flex items-center">
                ...
                />
                <label htmlFor="remember-me" className="mr-3 block text-sm font-bold text-slate-600 cursor-pointer">
                  تذكرني
                </label>
              </div>
          ...
          <div className="mt-10 text-center">
            <p className="text-sm text-slate-500 font-bold">
              ليس لديك حساب؟{" "}
              <Link href="/register" className="text-blue-600 hover:text-blue-700 font-black inline-flex items-center gap-1 group">
                أنشئ حسابك الآن <ArrowRight size={16} className="rotate-180 group-hover:-translate-x-1 transition-transform" />
              </Link>
            </p>
          </div>
        </div>
